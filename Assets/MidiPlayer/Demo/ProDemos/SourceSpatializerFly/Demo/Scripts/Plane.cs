...
namespace MFlight.Demo
{
    ...
    public class Plane : MonoBehaviour
    {
        ...
        [Header("Physics")]
        [Tooltip("Force to push plane forwards with")] public TextSlider thrust;
        [Tooltip("")] public float factorThrustCollision = 1f;
        ...
        {
            Debug.Log("Reset");
            transform.position = new Vector3(0f, 300f, -950f);
            transform.rotation = Quaternion.identity;
            controller.RotationCamera(Quaternion.identity);
        ...
        {
            //float angleCollision = Vector3.Angle(rigid.transform.forward, collision.collider.transform.forward);
            //Debug.Log($"{collision} {angleCollision}");
            //if (angleCollision < 60f || angleCollision > 120f)
            factorThrustCollision = -0.1f;
            ////transform.Rotate(0, 0, 90, Space.World);
            ////rigid.AddTorque(new Vector3(0,90,0),ForceMode.Impulse);
        ...
        private void FixedUpdate()
        {
            ...
            if (Input.GetKey(KeyCode.LeftControl))
            {
                if (factorThrustCollision < 1f) factorThrustCollision += Time.fixedDeltaTime / 10f;
                rigid.AddRelativeForce(Vector3.forward * thrust.Value * forceMult * factorThrustCollision, ForceMode.Force);
