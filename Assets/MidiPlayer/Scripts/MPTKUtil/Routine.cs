...
namespace MEC
{
    public class Routine : MonoBehaviour
    {
        ...
        private static Routine[] ActiveInstances = new Routine[16];
        private static Routine _instance;
        static public string InstanceName = "RoutineTimingController";
        public static Routine Instance
        {
            get
            {
                ...
                {
                    GameObject instanceHome = GameObject.Find(InstanceName);

                    if (instanceHome == null)
                    {
                        instanceHome = new GameObject { name = InstanceName };
                    ...
                    _instance = instanceHome.GetComponent<Routine>() ?? instanceHome.AddComponent<Routine>();
        ...
        public static Routine GetInstance(byte ID)
        {
            if (ID >= 0x10)
                return null;
        ...
        {
            Routine inst = GetInstance(handle.Key);
        ...
        {
            Routine inst = GetInstance(otherCoroutine.Key);
        ...
        public static float WaitUntilDone(AsyncOperation operation)
        {
            ...
            Routine inst = GetInstance(CurrentCoroutine.Key);
        ...
        {
            Routine instance = GetInstance(handle.Key);
    ...
    public struct CoroutineHandle : System.IEquatable<CoroutineHandle>
    {
        ...
        {
            if (Routine.GetTag(this) == null)
            {
                if (Routine.GetLayer(this) == null)
                    return Routine.GetDebugName(this);
                else
                    return Routine.GetDebugName(this) + " Layer: " + Routine.GetLayer(this);
            }
            else
            {
                if (Routine.GetLayer(this) == null)
                    return Routine.GetDebugName(this) + " Tag: " + Routine.GetTag(this);
                else
                    return Routine.GetDebugName(this) + " Tag: " + Routine.GetTag(this) + " Layer: " + Routine.GetLayer(this);
            }
        }
        ...
        public string Tag
        {
            get { return Routine.GetTag(this); }
            set { Routine.SetTag(this, value); }
        }
        ...
        public int? Layer
        {
            get { return Routine.GetLayer(this); }
            set
            {
                if (value == null)
                    Routine.RemoveLayer(this);
                else
                    Routine.SetLayer(this, (int)value);
            }
        }
        ...
        {
            get { return Routine.GetSegment(this); }
            set { Routine.SetSegment(this, value); }
        }
        ...
        {
            get { return Routine.IsRunning(this); }
            set { if (!value) Routine.KillCoroutines(this); }
        }
        ...
        {
            get { return Routine.IsAliveAndPaused(this); }
            set { if (value) Routine.PauseCoroutines(this); else Routine.ResumeCoroutines(this); }
        }
    ...
    public static class MECExtensionMethods1
    {
        ...
        {
            return Routine.RunCoroutine(coroutine);
        }
        ...
        {
            return Routine.RunCoroutine(coroutine, gameObj);
        }
        ...
        {
            return Routine.RunCoroutine(coroutine, layer);
        }
        ...
        {
            return Routine.RunCoroutine(coroutine, tag);
        }
        ...
        {
            return Routine.RunCoroutine(coroutine, gameObj, tag);
        }
        ...
        {
            return Routine.RunCoroutine(coroutine, layer, tag);
        }
        ...
        {
            return Routine.RunCoroutine(coroutine, segment);
        }
        ...
        {
            return Routine.RunCoroutine(coroutine, segment, gameObj);
        }
        ...
        {
            return Routine.RunCoroutine(coroutine, segment, layer);
        }
        ...
        {
            return Routine.RunCoroutine(coroutine, segment, tag);
        }
        ...
        {
            return Routine.RunCoroutine(coroutine, segment, gameObj, tag);
        }
        ...
        {
            return Routine.RunCoroutine(coroutine, segment, layer, tag);
        }
        ...
        {
            return Routine.RunCoroutineSingleton(coroutine, handle, behaviorOnCollision);
        }
        ...
        {
            return Routine.RunCoroutineSingleton(coroutine, layer, behaviorOnCollision);
        }
        ...
        {
            return Routine.RunCoroutineSingleton(coroutine, tag, behaviorOnCollision);
        }
        ...
        {
            return Routine.RunCoroutineSingleton(coroutine, layer, tag, behaviorOnCollision);
        }
        ...
        public static CoroutineHandle RunCoroutineSingleton(this IEnumerator<float> coroutine, CoroutineHandle handle, Segment segment,
            SingletonBehavior behaviorOnCollision)
        {
            return Routine.RunCoroutineSingleton(coroutine, handle, segment, behaviorOnCollision);
        }
        ...
        public static CoroutineHandle RunCoroutineSingleton(this IEnumerator<float> coroutine, Segment segment, int layer,
            SingletonBehavior behaviorOnCollision)
        {
            return Routine.RunCoroutineSingleton(coroutine, segment, layer, behaviorOnCollision);
        }
        ...
        public static CoroutineHandle RunCoroutineSingleton(this IEnumerator<float> coroutine, Segment segment, string tag,
            SingletonBehavior behaviorOnCollision)
        {
            return Routine.RunCoroutineSingleton(coroutine, segment, tag, behaviorOnCollision);
        }
        ...
        public static CoroutineHandle RunCoroutineSingleton(this IEnumerator<float> coroutine, Segment segment, int layer, string tag,
            SingletonBehavior behaviorOnCollision)
        {
            return Routine.RunCoroutineSingleton(coroutine, segment, layer, tag, behaviorOnCollision);
        }
        ...
        {
            return Routine.WaitUntilDone(newCoroutine);
        }
        ...
        {
            return Routine.WaitUntilDone(newCoroutine, tag);
        }
        ...
        {
            return Routine.WaitUntilDone(newCoroutine, layer);
        }
        ...
        {
            return Routine.WaitUntilDone(newCoroutine, layer, tag);
        }
        ...
        {
            return Routine.WaitUntilDone(newCoroutine, segment);
        }
        ...
        {
            return Routine.WaitUntilDone(newCoroutine, segment, tag);
        }
        ...
        {
            return Routine.WaitUntilDone(newCoroutine, segment, layer);
        }
