    ...
    public class MidiSpatializerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            try
            {
                ...
                {
                    commonEditor.DrawCaption("MIDI Spatializer Player - Dedicated Midi Synth by channel or track.", "https://paxstellar.fr/midi-file-player-detailed-view-2/", "db/d06/class_midi_player_t_k_1_1_midi_spatializer.html#details");
                ...
                {
                    commonEditor.DrawCaption("Midi Spatializer Player - Play MIDI and apply position for each instruments.", "https://paxstellar.fr/midi-file-player-detailed-view-2/", "db/d06/class_midi_player_t_k_1_1_midi_spatializer.html#details");
