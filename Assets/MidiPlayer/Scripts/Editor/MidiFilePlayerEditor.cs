    ...
    public class MidiFilePlayerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            try
            {
                ...
                commonEditor.DrawCaption("Midi File Player - Play MIDI from the internal MIDI DB.", "https://paxstellar.fr/midi-file-player-detailed-view-2/", "d7/deb/class_midi_player_t_k_1_1_midi_file_player.html#details");
