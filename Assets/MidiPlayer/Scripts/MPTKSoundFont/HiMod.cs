...
namespace MidiPlayerTK
{
    ...
    public class HiMod
    {
        ...
        public float fluid_mod_get_value(MPTKChannel chan, int key, int vel)
        {
            ...
            if (Src1 > 0)
            {
                ...
                {
                    v1 = ((Src1 >= 0) && (Src1 < 128)) ? chan.Controller((MPTKController)Src1) : 0;
            ...
            if (Src2 > 0)
            {
                ...
                {
                    v2 = ((Src2 >= 0) && (Src2 < 128)) ? chan.Controller((MPTKController)Src2) : 0;
